    ...
    return (   
      <View>
          ...
          <View style={styles.containerLive} >
              ...
              <TouchableHighlight style={styles.twitchLogo} onPress = { () => Linking.openURL('https://twitch.tv/studiorenegade')}>
                    <Image source={require('./images/twitch.png')} style={{height:55, width:55}} />
              </TouchableHighlight>
          </View> 
          <View>
