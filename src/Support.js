      ...
      <View>
        ...
        <View style={{justifyContent:'center', alignItems:'center'}} > 
            ...
            <View style={{width: '95%', marginTop:10}} >
                ...
                <Text style={styles.containerText}>
                    Aujourd'hui nous poursuivons notre but : vous proposer toujours plus de contenu tout en améliorant la qualité de ces derniers. Nous sommes nous mêmes donateurs de l'association de loi 1901. </Text>
                    Merci encore à vous !
                <Image source={require('./images/signature.png')} style={{width:250, height: 100, position:'absolute', left:125, top:200}} />       
            </View>
        </View>
        <View style={{height: 250, flexDirection: 'column', justifyContent:'space-around', alignItems:'center', marginTop:50}}>
          <TouchableOpacity onPress = { () => Linking.openURL('https://www.twitch.tv/subs/studiorenegade')}
            style={{flexDirection:'row', justifyContent:'space-around', alignItems:'center'}}
          >
                <Image source={require('./images/twitch.png')} style={{height:70, width:70}} />
                <Text style={styles.containerText}>S'abonner</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={()=> Linking.openURL('https://www.tipeee.com/stdrenegade')} >
                <Image source={require('./images/Tipeee_logo.png')} style={{height:50, width:135}} />
            </TouchableOpacity>
            <View style={styles.containerPaypal} >
                <TouchableOpacity onPress={()=>Linking.openURL('https://www.paypal.com/cgi-bin/webscr/?cmd=_s-xclick&hosted_button_id=QZXLDBZV3UEWS')} >
                    <Image source={require('./images/paypal.png')} style={{height:50, width:120}} />
                </TouchableOpacity>            
            </View>
        </View>
      </View>
